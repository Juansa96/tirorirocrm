...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Gestión de clientes, leads y productos para el equipo de ventas de Tiroriro Home." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "TiroCRM — Tiroriro Home" },
      { name: "twitter:description", content: "Gestión de clientes, leads y productos para el equipo de ventas de Tiroriro Home." },
    ],
